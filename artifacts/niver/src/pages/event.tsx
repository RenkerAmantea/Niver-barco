...
export default function Event() {
  ...
  return <div className="panel-enter space-y-7 pb-24">
    ...
    <section className="glass-card relative overflow-hidden rounded-3xl border-primary/35 bg-gradient-to-br from-[#241a0d]/90 via-[#151426]/95 to-[#0a1523]/95 p-5 shadow-[0_0_42px_rgba(201,168,76,.18)]">
      ...
      <a href="https://wa.me/55619989898198?text=Oi%20Renker%2C%20segue%20meu%20comprovante%20da%20contribui%C3%A7%C3%A3o%20do%20Niver%20Barco." target="_blank" rel="noreferrer" className="premium-cta shimmer relative mt-3 flex w-full items-center justify-center gap-2 rounded-2xl border border-[#fff0b4]/60 bg-gradient-to-r from-[#ffe399] via-[#efbd4f] to-[#c87520] px-4 py-3 text-sm font-bold text-[#150d05] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"><MessageCircle className="h-4 w-4" />Enviar comprovante no WhatsApp<ExternalLink className="h-3.5 w-3.5" /></a>
    </section>
    ...
    <section className="glass-card rounded-3xl p-5"><div className="flex items-center justify-between"><div><p className="text-xs uppercase tracking-widest text-muted-foreground">Tripulação confirmada</p><p className="mt-1 text-3xl font-display text-primary">{summary?.going ?? 0}</p></div><UsersRound className="h-9 w-9 text-primary/70"/></div><Button className="premium-cta shimmer mt-5 w-full border border-[#fff0b4]/60 bg-gradient-to-r from-[#ffe399] via-[#efbd4f] to-[#c87520] font-bold text-[#150d05] hover:brightness-110" onClick={() => setLocation('/convidados')}>Ver lista e confirmar presença</Button></section>
