...
const reactionOptions = [{ key: 'heart', label: 'Coração', icon: Heart, color: 'text-[#ff66ad]', fill: 'fill-[#ff66ad]' }, { key: 'thumb', label: 'Joinha', icon: ThumbsUp, color: 'text-[#5bbcff]', fill: 'fill-[#5bbcff]' }, { key: 'fire', label: 'Fogo', icon: Flame, color: 'text-[#ff9b4a]', fill: 'fill-[#ff9b4a]' }, { key: 'boat', label: 'Âncora', icon: Anchor, color: 'text-[#63dce8]', fill: 'fill-[#63dce8]' }];
