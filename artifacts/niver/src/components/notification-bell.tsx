...
export function NotificationBell() {
  ...
  return <div ref={panelRef} className="relative">
    ...
    {open && <section aria-label="Notificações" className="absolute right-0 top-12 z-[80] w-[min(22rem,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-white/12 bg-[#111326]/[.98] shadow-[0_22px_55px_rgba(0,0,0,.48)] backdrop-blur-2xl">
      ...
      <div className="max-h-[min(28rem,calc(100vh-9rem))] overflow-y-auto p-1.5">
